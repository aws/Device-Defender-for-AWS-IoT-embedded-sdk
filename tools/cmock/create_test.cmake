...
function( create_test test_name
    ...
    add_custom_command( OUTPUT ${test_name}_runner.c
                        COMMAND ruby ${CMOCK_DIR}/vendor/unity/auto/generate_test_runner.rb
...
function( preprocess_mock_list mock_name file_list compiler_args )
    ...
    foreach( target_file IN LISTS file_list )
        ...
        add_custom_target( pre_${mock_name} COMMAND mv ${target_file}.out ${target_file}
...
# Generates a mock library based on a module's header file and places the
# generated source file in the build directory.
#
# @param mock_name: Name of the target.
...
function( create_mock_list mock_name
    ...
    foreach( mock_file IN LISTS mock_list )
        ...
        add_custom_command ( OUTPUT ${mocks_dir}/mock_${mock_file_name}.c
                             COMMAND ruby ${CMOCK_DIR}/lib/cmock.rb
    ...
    target_include_directories( ${mock_name} PUBLIC ${mocks_dir} ${mock_include_list} )
...
#Function to create target for real library under test.
function( create_real_library target
    ...
    if( NOT( mock_name STREQUAL "" ) )
        ...
        target_link_libraries( ${target} -l${mock_name} -lgcov )
    endif()
endfunction()
